...
public class OutputCellRenderer extends DefaultTableCellRenderer implements
    DataEventListener
{
  ...
  public OutputCellRenderer(OutputsModel outputsModel,
  ...
  public void dataEvent(DataEvent dataEvent)
  {
    ...
    case ReceiverDataReceived:
      ReceiverChannel[] receiverChannels = aviLightConfigData
          .getReceiverChannelData();
    ...
    case VoltageReceived:
      boolean limited = (aviLightConfigData.getLimit() > 0.0)
          && (aviLightConfigData.getVoltage() < aviLightConfigData.getLimit());
