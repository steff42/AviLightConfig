...
public class MainWindow extends JFrame implements ActionListener
{
  ...
  private void initGui()
  {
    ...
    tab.addTab( "Schaltausgänge", new OutputsPanel( this, aviLightConfigData, OutputType.Switch ) );
  ...
  private void askForFirmwareUpgrade()
  {
    int confirm = JOptionPane.showConfirmDialog( this,
        "Keine Firmware auf dem Modul installiert. Soll ein Firmwareupgrade durchgeführt werden ?",
