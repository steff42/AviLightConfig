...
public class TestProtocol
{
  ...
  void testsync()
  {
    testSequence( new byte[] { 5, 3, 2, 0, 3, 7, 2, 0, 3 }, new Class<?>[] {
  ...
  {
    testSequence(new byte[] { 2, 0, 3, 2 },
        new Class<?>[] { CommEventPing.class } );
    testSequence( new byte[] { 0, 3 },
        new Class<?>[] { CommEventPing.class } );
  }
  ...
  void testInfo()
  {
    CommEventText commEventText = (CommEventText)  testSequence( new byte[] { 2, 1, 'H',
        'a', 'l', 'l', 'o', 3 }, new Class<?>[] { CommEventText.class } );
  ...
  void testTerminal()
  {
    CommEventText commEventText = (CommEventText) testSequence( new byte[] { 2, 2, 'T',
        'e', 'r', 'm', 'i', 'n', 'a', 'l', 3 },
        new Class<?>[] { CommEventText.class } );
  ...
  {
    CommEventChannelInfo commEventChannelInfo = (CommEventChannelInfo) testSequence( new byte[] { 2, 27, 3, 1,
        2, 27, 3, 3 }, new Class<?>[] { CommEventChannelInfo.class } );
...
//
//    CommEventChannelInfo commEventChannelInfo = (CommEventChannelInfo) aviLightProtocol
//        .getLastEvent();
//
//    Assert.assertEquals( 3, commEventChannelInfo.getSource() );
